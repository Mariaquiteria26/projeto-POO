    ...
    <div class="w-full max-w-2xl bg-white rounded-3xl shadow-lg p-10">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-gray-400 text-sm mt-2">
                Adicione um novo doce ao catálogo da confeitaria.
            </p>
        </div>
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#e60062] focus:outline-none text-sm text-gray-700 placeholder-gray-300 resize-y"></textarea>
                </div>
