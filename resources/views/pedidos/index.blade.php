            ...
            <div>
                ...
                <nav class="space-y-2">
                    <a href="{{ route('dashboard') }}"
                       ...
                       {{ request()->routeIs('dashboard') ? 'bg-[#e60062] text-white shadow-lg shadow-pink-200' : 'hover:bg-pink-100 text-black' }}">
                        <svg class="w-7 h-7 {{ request()->routeIs('dashboard') ? 'text-white' : 'text-[#e60062]' }}" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('doces.index') }}"
                       ...
                       {{ request()->routeIs('doces.*') ? 'bg-[#e60062] text-white shadow-lg shadow-pink-200' : 'hover:bg-pink-100 text-black' }}">
                        <svg class="w-7 h-7 {{ request()->routeIs('doces.*') ? 'text-white' : 'text-[#e60062]' }}" fill="none" stroke="currentColor" stroke-width="2.4" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('pedidos.index') }}"
                       class="flex items-center gap-4 px-5 py-3.5 rounded-xl font-semibold transition
                       {{ request()->routeIs('pedidos.*') ? 'bg-[#e60062] text-white shadow-lg shadow-pink-200' : 'hover:bg-pink-100 text-black' }}">
                        <svg class="w-7 h-7 {{ request()->routeIs('pedidos.*') ? 'text-white' : 'text-[#e60062]' }}" fill="none" stroke="currentColor" stroke-width="2.4" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('fornecedores.index') }}"
                       class="flex items-center gap-4 px-5 py-3.5 rounded-xl font-semibold transition
                       {{ request()->routeIs('fornecedores.*') ? 'bg-[#e60062] text-white shadow-lg shadow-pink-200' : 'hover:bg-pink-100 text-black' }}">
                        <svg class="w-7 h-7 {{ request()->routeIs('fornecedores.*') ? 'text-white' : 'text-[#e60062]' }}" fill="none" stroke="currentColor" stroke-width="2.4" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('usuarios.index') }}"
                       class="flex items-center gap-4 px-5 py-3.5 rounded-xl font-semibold transition
                       {{ request()->routeIs('usuarios.*') ? 'bg-[#e60062] text-white shadow-lg shadow-pink-200' : 'hover:bg-pink-100 text-black' }}">
                        <svg class="w-7 h-7 {{ request()->routeIs('usuarios.*') ? 'text-white' : 'text-[#e60062]' }}" fill="none" stroke="currentColor" stroke-width="2.4" viewBox="0 0 24 24">
                ...
                <table class="w-full border-collapse">
                    <thead>
                        <tr class="bg-pink-50 text-[#e60062]">
                            <th class="text-left px-5 py-4 rounded-l-xl">Cliente</th>
                            <th class="text-left px-5 py-4">Doce</th>
                            <th class="text-left px-5 py-4">Quantidade</th>
